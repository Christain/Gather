...
public class InterestActAdapter extends SuperAdapter {
	...
	public InterestActAdapter(Context context) {
		super(context);
	...
	public View getView(int position, View convertView, ViewGroup arg2) {
		...
		holder.llActInterest.setOnClickListener(new OnInterestClickListener(model, position));
	...
	private class OnInterestClickListener implements OnClickListener {
		...
		public OnInterestClickListener(ActModel model, int position) {
			this.model = model;
		...
		public void onClick(View arg0) {
			if (!isRequest) {
				...
				case 0:
					...
					break;
				case 1:
					CancelInterestAct(model, position);
					break;
				}
			}
		}
	 ...
	 * 取消兴趣活动
	 */
	private void CancelInterestAct(final ActModel model, final int position) {
